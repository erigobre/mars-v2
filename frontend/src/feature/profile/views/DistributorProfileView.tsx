...
export default function DistributorProfileView() {
  ...
  } = useForm<DistributorProfileForm>({
    resolver: zodResolver(distributorProfileFormSchema),
    mode: "onChange",
  });
  ...
  const onSubmit = (data: DistributorProfileForm) => {
          ...
          >
            <section>
              <h3 className="text-lg font-bold text-gray-800 border-b border-gray-100 pb-3 mb-6 flex items-center">
                <MdBusiness className="mr-2 text-primary text-xl" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div>
                    <Input
                      ...
                      leftIcon={<MdEmail />}
                      error={errors.email}
                      hint="El correo es único por cuenta."
                      {...register("email")}
                    />
                  </div>
                  <div>
