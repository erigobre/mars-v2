...
class StoreProductRequest extends CamelCaseRequest
{
    /**
    ...
    public function rules(): array
    {
        return array_merge(
            ...
            [
                ...
                'upc'              => 'nullable|string|unique:products,upc',
                'name'             => 'required|string|max:255',
                'description'      => 'nullable|string',
                'default_price'    => 'required|numeric|min:0',
                'unit_type'        => ['required', 'string', 'max:50', Rule::in(UnitType::values())],
    ...
    public function attributes(): array
    {
        return [
            ...
            'custom_unit_type' => 'unidad personalizada',
            'category'         => 'categoría',
            'is_active'        => 'activo',
        ];
    }
