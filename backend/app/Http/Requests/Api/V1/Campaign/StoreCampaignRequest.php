...
class StoreCampaignRequest extends CamelCaseRequest
{
    public function authorize(): bool
    {
        return true; // Policy en el controller
    }
    ...
    {
        parent::prepareForValidation(); // camelCase → snake_case
        ...
        $this->merge([ // Aseguramos que los booleanos tengan un valor por defecto
